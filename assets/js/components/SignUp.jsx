...
{
  /*component with custom form widget*/
}
...
{
  /*function to validate form or display error if needed*/
}
...
{
  /*Component to sign up (not used yet*/
}
...
let SignUp = ({
  ...
  return (
    ...
    {/*redux tool to use redux action to post values to database*/}
